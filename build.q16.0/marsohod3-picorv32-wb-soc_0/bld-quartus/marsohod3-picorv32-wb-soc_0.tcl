project_new marsohod3-picorv32-wb-soc_0 -overwrite
set_global_assignment -name FAMILY "MAX 10"
set_global_assignment -name DEVICE 10M50SAE144C8GES
set_global_assignment -name TOP_LEVEL_ENTITY marsohod3_picorv32_wb_soc
...
set_global_assignment -name VERILOG_FILE ../src/marsohod3-picorv32-wb-soc_0/rtl/verilog/aux.v
set_global_assignment -name VERILOG_FILE ../src/marsohod3-picorv32-wb-soc_0/rtl/verilog/marsohod3_picorv32_wb_soc.v
set_global_assignment -name VERILOG_FILE ../src/marsohod3-picorv32-wb-soc_0/rtl/verilog/max10-altpll/altpll0.v
set_global_assignment -name SDC_FILE ../src/marsohod3-picorv32-wb-soc_0/data/marsohod3.sdc
source ../src/marsohod3-picorv32-wb-soc_0/data/marsohod3-pinmap.tcl
source ../src/marsohod3-picorv32-wb-soc_0/data/options.tcl
